...
├── helpers.js            # Utility: groupByRank, findStraights, sortHand, detectComboGroups
...
- **Auto-Select Combo**: Khi chọn 1 lá thuộc group (cùng màu), tự động chọn tất cả lá trong group nếu combo hợp lệ
  - Ví dụ: đối thủ đánh đôi 3 → chọn 1 lá 4 → tự chọn thêm lá 4 còn lại
  - Không áp dụng nếu combo không hợp lệ (ví dụ: đối thủ đánh lẻ thì không tự chọn đôi)
- **Drag & Drop**: Kéo thả để sắp xếp lại vị trí bài trên tay
- **Timer**: Đếm ngược 15 giây mỗi lượt, tự động bỏ lượt khi hết giờ
- **Controls**:
